...
17. [Frozen local defensive response form protocol v1](protocols/local_defensive_response_form_v1.md), [prospective pooled-execution clarification](protocols/local_defensive_response_form_v1_pooled_execution_clarification.md) (`1ba4e198...e23cf794`), [Game 1 development result](results/local_defensive_response_form_game1_v1.md), [configuration](../config/local_defensive_response_form_v1.json), [pooled addendum configuration](../config/local_defensive_response_form_v1_pooled_execution_clarification.json) (`70f0d6ad...b8a9c813`), and [prior-art note](local_defensive_response_form_methodology.md) — development coherent; unchanged Game 2 replication remains unexecuted.
...
| Local defensive response form v1 | [frozen protocol](protocols/local_defensive_response_form_v1.md) | `src/local_defensive_response_form_game1_v1.py` | [Game 1 development result](results/local_defensive_response_form_game1_v1.md) |
