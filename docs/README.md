...
28. [Opportunity Redistribution v1 protocol](protocols/opportunity_redistribution_v1.md) and [focused construct/literature audit](opportunity_redistribution_v1_methodology.md) — prospectively frozen Game 1 development design linking the replicated defensive contrast to differential nearest-defender separation for other attackers; no opportunity outcome has been computed.
...
| Opportunity Redistribution v1 design | [frozen protocol](protocols/opportunity_redistribution_v1.md) and [methodology audit](opportunity_redistribution_v1_methodology.md) | `src/opportunity_redistribution_v1.py` (pure geometry only) | Results unobserved; Game 1 execution requires separate authorization |
