...
16. [Frozen spatial defensive-response footprint protocol v1.0](protocols/spatial_defensive_response_footprint_v1.md) and [Game 1 result](results/spatial_defensive_response_footprint_game1_v1.md) — development coherent: near-minus-middle passed its frozen 97.5% interval and robustness gates; middle-minus-far was null; Game 2 remains unobserved.
