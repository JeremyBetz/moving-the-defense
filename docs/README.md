...
15. [Frozen attacker-to-defender bridge protocol v1.0](protocols/attacker_defender_bridge_v1.md) — first observational test linking preceding attacker path to subsequent local focal-relative defensive movement; its pre-execution clarification freezes Game 1 development status and exact bootstrap mechanics, with no result yet.
