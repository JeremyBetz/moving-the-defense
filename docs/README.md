...
6. [Frozen Phase 5A contextual-expectation protocol](phase5a_contextual_expectation_protocol.md) and [methodology provenance](contextual_expectation_methodology.md)
