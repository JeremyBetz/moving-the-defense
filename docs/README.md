...
16. [Frozen spatial defensive-response footprint protocol v1.0](protocols/spatial_defensive_response_footprint_v1.md), [held-out execution clarification](protocols/spatial_defensive_response_footprint_v1_execution_clarification.md), and [Game 1 result](results/spatial_defensive_response_footprint_game1_v1.md) — development coherent; Game 2 remains unobserved and will be reported descriptively before the already-frozen pooled/final step.
...
| Spatial defensive-response footprint v1 | [frozen protocol](protocols/spatial_defensive_response_footprint_v1.md) | `src/spatial_defensive_response_footprint_game1_v1.py` | [Game 1 development result](results/spatial_defensive_response_footprint_game1_v1.md) |
