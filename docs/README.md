...
27. [Game 1 concurrent-geometry result](results/concurrent_attacker_defensive_geometry_game1_v1.md) and [frozen Game 2 replication governance](protocols/concurrent_attacker_defensive_geometry_v1_game2_replication.md) — development coherent; untouched Game 2 rules frozen with the original near-minus-middle contrast and no post-hoc D1/shape criterion.
...
| Concurrent geometry Game 1 / heldout governance | [original protocol](protocols/concurrent_attacker_defensive_geometry_v1.md) and [Game 2 addendum](protocols/concurrent_attacker_defensive_geometry_v1_game2_replication.md) | `src/concurrent_attacker_defensive_geometry_game1_v1.py` | [Game 1 development](results/concurrent_attacker_defensive_geometry_game1_v1.md); Game 2 results unobserved |
