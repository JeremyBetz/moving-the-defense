...
25. [Attacker Movement Episode v2](protocols/attacker_movement_episode_v2.md) and [Game 1 development result](results/attacker_movement_episode_v2_game1.md) — direction-aware consolidation classified development COHERENT: fragmentation fell to 28.76% while merging/direction remained below 3.97%, but long episodes doubled and a roughly 51-second pathology persisted. No Game 2 or defensive outcome was opened.
...
| Attacker Movement Episode v2 | [frozen protocol](protocols/attacker_movement_episode_v2.md) | `src/attacker_movement_episode_v2.py` | [Game 1 development](results/attacker_movement_episode_v2_game1.md) |
