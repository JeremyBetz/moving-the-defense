...
15. [Frozen attacker-to-defender bridge protocol v1.0](protocols/attacker_defender_bridge_v1.md) and [Game 1 development result](results/attacker_defender_bridge_game1_v1.md) — the first observational bridge classified GAME 1 DEVELOPMENT COHERENT under every frozen local, nonlocal, temporal, horizon, exposure, QC, and reproduction criterion; Game 2 remains uncomputed.
