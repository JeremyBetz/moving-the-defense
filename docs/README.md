...
26. [Frozen Concurrent Attacker–Defensive Geometry v1](protocols/concurrent_attacker_defensive_geometry_v1.md) and [methodology provenance](concurrent_attacker_defensive_geometry_v1_provenance.md) — one two-second concurrent attacker/defender geometry design, frozen with results unobserved; no episode boundaries, temporal-order claim, or tactical semantics.
...
| Concurrent Attacker–Defensive Geometry v1 | [frozen protocol](protocols/concurrent_attacker_defensive_geometry_v1.md) | `src/concurrent_attacker_defensive_geometry_v1.py` (synthetic geometry only; no empirical execution yet) | Results unobserved |
