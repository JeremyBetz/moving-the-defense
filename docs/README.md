...
14. [Frozen held-out Game 2 continuous-representation protocol](protocols/attacking_continuous_movement_game2_heldout_v1.md) and [Stage-A support result](results/attacking_continuous_movement_game2_stage_a.md) — raw trajectory-QC/registry checkpoint classified READY; continuous features remain uncomputed.
