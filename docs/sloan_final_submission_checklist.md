...
- [x] Structured abstract: 403 body words; 416 including the nine-word title and four section headings (whitespace-delimited count).
...
- [x] Two-figure main-submission plan; comprehensive results table remains supplementary.
- [x] Public repository and [reproduction guide](../REPRODUCE.md).
- [x] Public IDSSE/DFL [Figshare dataset](https://doi.org/10.6084/m9.figshare.28196177.v1) documented with its CC BY 4.0 license and seven exact match IDs.
...
- [ ] Save the exact submitted title, abstract, and files locally.
- [ ] Record the confirmation number, confirmation email, and submission timestamp.

## Dates already documented

- [x] Abstract deadline: October 1, 2026, 11:59 p.m. EST.
- [x] If invited, full-paper deadline: December 4, 2026, 11:59 p.m.

Portal instructions control if they differ from these recorded requirements.
